...
def getNumberOfParameters(covarname, input_dimension):
    ...
    try:
        ...
        if covarname == 'Polynomial3':
            ...
            return getNumberOfParameters('Polynomial3', input_dimension) + getNumberOfParameters('Matern52',
                                                                                                 input_dimension)
        else:
...
class GPModel(object):
    ...
    def __init__(self, X, y, mean, noise, amp2, ls, covarname="Matern52", cholesky=None, alpha=None, cov_func=None,
                 covar_derivative=None):
        '''
            Constructor
            Args:
    ...
    def copy(self):
        ...
        L = copy.copy(self._L)
        alpha = self._alpha
        return GPModel(X, y, self._mean, self._noise, self._amp2, ls, None, L, alpha, self._cov_func,
                       self._covar_derivative)
